...
class AssociationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create association" do
    assert_difference('Association.count') do
      post associations_url, params: { association: { pageID: @association.pageID, pagename: @association.pagename } }
    end

    assert_redirected_to association_path(Association.last)
  end
  ...
  test "should update association" do
    patch association_url(@association), params: { association: { pageID: @association.pageID, pagename: @association.pagename } }
    assert_redirected_to association_path(@association)
  end
